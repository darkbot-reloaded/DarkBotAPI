...
public interface SelectableItem {
    ...
    enum Ability implements SelectableItem {
        SPEARHEAD_CLOAKING("ability_spearhead_ultimate-cloak"),
        SPEARHEAD_JAMX("ability_spearhead_jam-x"),
        SPEARHEAD_MARKER("ability_spearhead_target-marker"),
        SPEARHEAD_RECON("ability_spearhead_double-minimap"),
        AEGIS_HPREP("ability_aegis_hp-repair"),
        AEGIS_SHDREP("ability_aegis_shield-repair"),
        AEGIS_REPPOD("ability_aegis_repair-pod"),
        CITADEL_DRAWFIRE("ability_citadel_draw-fire"),
        CITADEL_TRAVEL("ability_citadel_travel"),
        CITADEL_PROTECTION("ability_citadel_protection"),
        CITADEL_FORTIFY("ability_citadel_fortify"),
        SOLACE_REPAIR("ability_solace"),
        SPECTRUM_PRISMATIC("ability_spectrum"),
        VENOM_SINGULARITY("ability_venom"),
        SENTINEL_FORTRESS("ability_sentinel"),
        DIMINISHER_WEAKEN("ability_diminisher"),
        LIGHTNING_AFTERBURNER("ability_lightning"),
        ADMIN_CLOAKING("ability_admin-ultimate-cloaking"), // unavailable
        TARTARUS_SPEEDBOOST("ability_tartarus_speed-boost"),
        TARTARUS_RAPIDFIRE("ability_tartarus_rapid-fire"),
        MIMESIS_HOLOGRAM("ability_mimesis_hologram"), // unavailable
        MIMESIS_SCRAMBLE("ability_mimesis_scramble"),
        MIMESIS_PHASEOUT("ability_mimesis_phase-out"),
        GOLIATHX_FROZENCLAW("ability_goliath-x_frozen-claw"),
        HECATE_BEAM("ability_hecate_particle-beam"),
        DISRUPTOR_REDIRECT("ability_disruptor_redirect"),
        DISRUPTOR_DISARRAY("ability_disruptor_shield-disarray"),
        DISRUPTOR_DDOL("ability_disruptor_ddol"),
        BERSERKER_SHIELDLINK("ability_berserker_shl"),
        BERSERKER_BERSERK("ability_berserker_bsk"),
        BERSERKER_REVENGE("ability_berserker_rvg"),
        ZEPHYR_MOMENTUM("ability_zephyr_mmt"),
        ZEPHYR_TRPBARRAGE("ability_zephyr_tbr"),
        SOLARIS_INCINERATE("ability_solaris_inc"),
        KERES_SPREAD("ability_keres_spr"),
        KERES_SLEIGHT("ability_keres_sle"),
        RETIARUS_SUPERCHARGE("ability_retiarus_spc"),
        RETIARUS_CHARGESHOT("ability_retiarus_chs"),
        ORCUS_ASSIMILATE("ability_orcus_assimilate"),
        HOLO_SELFREVERSAL("ability_holo_self-reversal"),
        HOLO_ENEMYREVERSAL("ability_holo_enemy-reversal");
